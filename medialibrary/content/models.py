...
class MediaFileContent(models.Model):
    ...
    * content/mediafile/default.html
    ...
    def initialize_type(cls, POSITION_CHOICES = None, MEDIAFILE_CLASS = MediaFile):
        if 'medialibrary' not in settings.INSTALLED_APPS:
            raise ImproperlyConfigured, 'You have to add \'medialibrary\' to your INSTALLED_APPS before creating a %s' % cls.__name__

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('medialibrary_mediafile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('thumbs.models.ImageWithThumbsField')(max_length=255, name='file', sizes=((132, 97), (80, 80)))),
    ...
    models = {
        ...
        'medialibrary.mediafile': {
            ...
            'file': ('thumbs.models.ImageWithThumbsField', [], {'max_length': '255', 'name': "'file'", 'sizes': '((132, 97), (80, 80))'}),
